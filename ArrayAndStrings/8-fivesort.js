...
//APPROACH
- use two pointers, if there is a 5, increment or decrement to the next number
- if there isnt a 5 on one pointer, and there is a pointer on the other 5, swap them
- if the first pointer is equal to 5, swap it with the second pointer that is not a 5
