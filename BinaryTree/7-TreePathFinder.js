...
//Recursive solution
Base Cases
1. if root.val is equal to the target, return the root
2. if root is equal to null, return null
3. if target is found in left or right, then return that value and the root of the current one
